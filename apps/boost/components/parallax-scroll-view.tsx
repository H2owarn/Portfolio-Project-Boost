...
import { type ScrollViewProps, type StyleProp, StyleSheet, View, type ViewStyle } from 'react-native';
import Animated, {
	Extrapolation,
	interpolate,
	useAnimatedRef,
	...
	return (
		<View style={[styles.container, { backgroundColor }]}>
			<Animated.ScrollView
				...
				contentContainerStyle={[styles.scrollContent, { paddingTop: HEADER_HEIGHT }, contentContainerStyle]}
			>
				<ThemedView lightColor={surfaceColorLight} darkColor={surfaceColorDark} style={[styles.content, contentStyle]}>
					{children}
				</ThemedView>
			</Animated.ScrollView>
